...
def generate_ini(hosts: dict, key_path: str = None) -> str:
    ...
    lines = [
        ...
        "",
        "[windows_nodes]",
        f"windows ansible_host=127.0.0.1 ansible_port=5985 windows_internal_ip={windows_ip} ansible_user=Administrator ansible_password=SOCForge@2026!Sec ansible_connection=winrm ansible_winrm_server_cert_validation=ignore ansible_winrm_transport=basic",
        "",
        "[windows_nodes:vars]",
        "ansible_user=Administrator",
        "ansible_password=SOCForge@2026!Sec",
